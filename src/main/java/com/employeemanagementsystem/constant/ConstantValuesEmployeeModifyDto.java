...
public class ConstantValuesEmployeeModifyDto {
	...
	public static final String regexpModifyUser  = "^[a-zA-Z]+( [a-zA-Z]+)*$";
	
	public static final String modifyUserNotBlankMessage="Modify User is mandatory";
	
	public static final String modifyUserSizeMessage="Modify User must be between 2 and 50 characters";

	public static final String modifyUserregexpMessage="Modify User must contain only alphabet characters and spaces between words, with no leading or trailing spaces";
